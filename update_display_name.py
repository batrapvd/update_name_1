#!/usr/bin/env python3
"""
Populate the coordinate_speed.display_name column using Nominatim reverse geocoding.

Designed to run in the background; it keeps looping when --loop is provided so new
rows get processed automatically.
"""
